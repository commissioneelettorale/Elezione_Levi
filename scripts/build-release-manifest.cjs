...
const files=['index.html','anonimato.html','note-legali.html','fascicolo-dpo.html','docs/verifiche-sviluppo.json','docs/19_FASCICOLO_DPO_E_RIPRESA.md','api/call.js','functions/core.js','firestore.rules','vercel.json','package.json','package-lock.json'];
