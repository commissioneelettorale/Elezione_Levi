...
Generare prima dell’autorizzazione i lotti per componente/classe, da 1 a 250 cedolini alla volta. Il totale emesso non può superare gli aventi diritto registrati nel gruppo. Il server genera 128 bit casuali per codice e conserva solo l’hash del codice con l’anno. La raccolta delle credenziali contiene componente/classe e flag, nessun nome o ID del registro. Il lotto registra soltanto quantità, gruppo e riferimento amministrativo. Le urne continuano a usare identificativi casuali indipendenti.
